...
silent only
cd ~\GoogleDrive\Documents\EmbeddedDesign\Homework4\Problem_3
...
exe 'vert 1resize ' . ((&columns * 74 + 73) / 147)
exe '2resize ' . ((&lines * 19 + 20) / 41)
exe 'vert 2resize ' . ((&columns * 74 + 73) / 147)
exe 'vert 3resize ' . ((&columns * 72 + 73) / 147)
argglobal
setlocal keymap=
setlocal noarabic
